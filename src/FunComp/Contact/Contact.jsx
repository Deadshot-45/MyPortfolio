...
const Contact = () => {
  return (
    <>
      <div className="m-6 w-full flex-col items-center justify-center py-16 max-xsm:py-12 rounded-3xl bg-[#121214]">
        <div className="w-[80%] flex flex-col gap-2 max-xsm:gap-0 mx-auto items-center justify-center">
          <h1 className="text-orange-500 text-2xl xsm:text-xl font-bold max-xsm:text-[20px]">Get in Touch</h1>
          <p className="xsm:text-sm md:text-xl max-xsm:text-[12px]">Phone: +91 930-190-9040</p>
          <p className="xsm:text-sm md:text-xl max-xsm:text-[12px]">Email: mayanksahu8179@gmail.com</p>
        </div>
