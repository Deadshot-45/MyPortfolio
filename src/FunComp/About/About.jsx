    ...
    <>
      <div className="my-10 max-xsm:my-0 flex flex-col items-center justify-center gap-10 w-full">
        <div className="flex flex-col gap-2 w-full xsm:min-w-[90%]">
          <h1 className="text-2xl xsm:text-[22px] font-bold text-orange-600 max-xsm:text-[20px]">Educations</h1>
          <hr className=" w-full" />
        </div>
          ...
          {Education.map((degree)=>(
            ...
            <div className="flex flex-col gap-6 xsm:gap-4 p-4">
              <div className="flex justify-between items-center">
                ...
                <p className="text-center max-xsm:text-[10px] max-xsm:leading-5">{degree.year}</p>
              </div>
      ...
      <div className="my-10 max-xsm:text-[10px] flex flex-col items-center justify-center gap-10 w-full">
        <div className="flex flex-col gap-2 w-full xsm:min-w-[90%]">
          <h1 className="text-2xl font-bold text-orange-600 xsm:text-[22px] max-xsm:text-[20px]">Skills</h1>
          <hr className=" w-full" />
        </div>
        ...
        <div key={skill.id} className="bg-[#121214] lg:min-h-80 lg:w-[32%] md:w-[80%] mb-10 hover:scale-105 transition-all delay-75 duration-150 flex flex-Wrap justify-between rounded-3xl p-6">
            ...
            <div className="flex justify-between">
              <h2 className="text-2xl xsm:text-xl font-bold max-xsm:text-[20px]">{skill.name}</h2>
            </div>
